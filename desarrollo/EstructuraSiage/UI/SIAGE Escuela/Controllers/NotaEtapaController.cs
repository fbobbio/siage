...
namespace SIAGE_Escuela.Controllers
{
    ...
    public class NotaEtapaController : Controller
    {
        ...
        #region Post
            ...
            {
                Rule.RegistrarNotaEtapa(model);
            }
        #endregion
        
        /** Región para declarar métodos de procesamiento que devuelvan JsonResults*/
        #region Procesamiento Busquedas
            public JsonResult ProcesarBusqueda(string sidx, string sord, int page, int rows, int? id, string filtroAnio, string filtroTurno, string filtroDivision, string asignatura, string filtroEtapa)
            {
                ...
                /****************************** INICIO AREA EDITABLE ******************************/
                var idEscuela = (int)Session[Siage.Base.ConstantesSession.EMPRESA.ToString()];
                var registros = Rule.GenerarNotaDeEtapa(idEscuela, filtroAnio, filtroTurno, filtroDivision, asignatura, filtroEtapa);
                //    /******************************** FIN AREA EDITABLE *******************************/
